...
Both the \texttt{FEEvaluation} and \texttt{FEFaceEvaluation} classes use template parameters for
...
\begin{itemize}
  ...
  \item \texttt{GridTools::find\_active\_cell\_around\_point()} no longer throws an exception when no cell is found, but returns an invalid iterator.
