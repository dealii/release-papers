...
\author[13]{Konrad Simon}
  \affil[13]{Department of Mathematics/Center for Earth System Research and Sustainability (CEN),
...
\item \texttt{step-79} is a program for topology optimization. Written
  ...
  functional). It uses advanced optimization techniques.
\end{itemize}
